...
const AdminSidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-screen w-80 flex-col border-r border-border/80 bg-card/95 backdrop-blur transition-transform duration-200 ease-in-out",
