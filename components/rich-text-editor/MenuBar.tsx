...
import { markdownToJson } from "@/lib/utlis/markdown-to-json"
...
const MenuBar = ({ editor }: MenuBarProps) => {
  ...
  const handleAcceptCompose = (markdown: string) => {
    try {
      ...
      console.error(
        "Something went wrong while converting markdown to Json in Editor ",
        error,
      )
    }
  }
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                disabled={!editorState?.canUndo} //editor cant undo then disable the button
              >
                <Undo />
              </Button>
            </TooltipTrigger>
